    ...
    public partial class CTicket
    {
        ...
        public CTicket()
        {
            try
            {
                ...
                fuentePequeña = new Font("Segoe UI", 4, FontStyle.Regular);
                fuenteNormal = new Font("Segoe UI", 5, FontStyle.Regular);
                fuenteResaltada = new Font("Segoe UI", 5, FontStyle.Bold);
                y = 0;
            }
