...
{
    public partial class frmOpcionesAvanzadasCaja : Form
    {
        frmEncabezados encabezado = new frmEncabezados();
        public frmOpcionesAvanzadasCaja()
        {
            InitializeComponent();
        }
        ...
        private void frmOpcionesAvanzadasCaja_Load(object sender, EventArgs e)
        {
            cargarDatosReporte();
        }

        private void frmOpcionesAvanzadasCaja_FormClosing(object sender, FormClosingEventArgs e)
        {
            guardarDatosReporte();
            Hide();
            e.Cancel = true;
