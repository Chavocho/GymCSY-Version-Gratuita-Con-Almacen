...
{
    public partial class frmOpcionesAvanzadasProducto : Form
    {
        frmEncabezados encabezado = new frmEncabezados();
        public frmOpcionesAvanzadasProducto()
        {
            InitializeComponent();
        ...
        private void frmOpcionesAvanzadasProducto_FormClosing(object sender, FormClosingEventArgs e)
        {
            guardarDatosReporte();
            e.Cancel = true;
            Hide();
        }
        private void frmOpcionesAvanzadasProducto_Load(object sender, EventArgs e)
        {
            cargarDatosReporte();
        }
