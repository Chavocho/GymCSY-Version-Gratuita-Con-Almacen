...
{
    public partial class frmOpcionesAvanzadasUsuario : Form
    {
        frmEncabezados encabezado = new frmEncabezados();
        public frmOpcionesAvanzadasUsuario()
        {
            InitializeComponent();
        }
        ...
        private void frmOpcionesAvanzadasUsuario_Load(object sender, EventArgs e)
        {
            
            cargarDatosReporte();
        }

        private void frmOpcionesAvanzadasUsuario_FormClosing(object sender, FormClosingEventArgs e)
        {
            guardarDatosReporte();
            Hide();
            e.Cancel = true;
