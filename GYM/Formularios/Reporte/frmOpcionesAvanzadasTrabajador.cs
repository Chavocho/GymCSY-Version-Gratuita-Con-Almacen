...
{
    public partial class frmOpcionesAvanzadasTrabajador : Form
    {
        frmEncabezados encabezado = new frmEncabezados();
        public frmOpcionesAvanzadasTrabajador()
        {
            InitializeComponent();
        }
        ...
        private void chboxObservacionesArchivoReporteTrabajadores_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void frmOpcionesAvanzadasTrabajador_Load(object sender, EventArgs e)
        {
            cargarDatosReporte();
        }

        private void frmOpcionesAvanzadasTrabajador_FormClosing(object sender, FormClosingEventArgs e)
        {
            guardarDatosReporte();
            Hide();
            e.Cancel = true;
        ...
        private void chboxEntradasTrabajador_CheckedChanged(object sender, EventArgs e)
        {
            gBoxEntradas.Enabled = chboxEntradasTrabajador.Checked;
        }

        private void chboxTodasLasEntradas_CheckedChanged(object sender, EventArgs e)
        {
            dtp2.Enabled = dtp1.Enabled = !chboxTodasLasEntradas.Checked;
